<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewProductPage.aspx.cs" Inherits="electronic_store.NewProductPage" %>
        ...
        <section class="newProduct">
            ...
            <div class="grid wide newProduct__container">
                <ul class="row newProduct-list">
                    <% 
                        List<electronic_store.Objects.NewProduct> listProductNew = (List<electronic_store.Objects.NewProduct>)Application["ListNewPage"];
                        foreach (electronic_store.Objects.NewProduct p in listProductNew)
                        { %>
                    <li class="col l-3">
