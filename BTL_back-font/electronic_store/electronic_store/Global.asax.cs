...
namespace electronic_store
{
    public class Global : System.Web.HttpApplication
    {
        ...
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            ListNewPage.Add(new Objects.NewProduct("N5" , "2b345e90ecd745a8adcc155a38a89c70-523980-3._w280_p1_" , "Tronsmart Sounfii R4 TWS ENC Call Noise Reduction", 13.81 , 16.25 , 0 , "Free"));
            ListNewPage.Add(new Objects.NewProduct("N6", "GPD-Win-4--2024--AMD-Ryzen-7-8840U-EU-Plug-523989-0._w280_p1_", "GPD Win 4 (2024) 6-inch Handheld Game Laptop, AMD", 799.08, 1011.24, 9, ""));
            ListNewPage.Add(new Objects.NewProduct("N7", "KUMI-GT6-Pro-Smartwatch-524110-0._w280_p1_", "KUMI GT6 Pro Smartwatch, 1.3-inch AMOLED HD Screen", 29.26, 34.13, 0, "Free"));
            ListNewPage.Add(new Objects.NewProduct("N8", "KUMI-GW6-Smartwatch-Black-524140-0._w280_p1_", "KUMI GW6 Smartwatch, 1.43-inch AMOLED HD Screen", 28.44, 34.13, 0, "Free"));
            ListNewPage.Add(new Objects.NewProduct("N9", "KUMI-KU7-Smartwatch-Black-524139-0._w280_p1_", "KUMI KU7 Smartwatch, 1.96'' AMOLED Screen, Bluetooth", 13.81, 16.25, 0, "Free"));
            ListNewPage.Add(new Objects.NewProduct("N10", "LED-Light-Wrist-Strap-Watch-524007-0._w280_p1_", "LED Light Wrist Strap Waterproof Watch", 10.56, 26.82, 1, "Free"));
            ListNewPage.Add(new Objects.NewProduct("N11", "M033-Transparent-Wireless-Mouse-White-524058-0._w280_p1_", "M033 Transparent Wireless Mouse, 3 Connection Modes", 8.83, 10.56, 2, "Free"));
            ListNewPage.Add(new Objects.NewProduct("N12", "R8-Smart-Ring-Black-S-524115-0._w280_p1_", "R8 Nano Ceramic + Antibacterial Stainless Steel", 31.69, 48.77, 1, "Free"));
            ListNewPage.Add(new Objects.NewProduct("N13", "Smart-Touchscreen-Bluetooth-Earbuds-Golden-524006-0._w280_p1_", "Tronsmart Sounfii R4 TWS ENC Call Noise Reduction", 13.81, 16.25, 0, "Free"));
            ListNewPage.Add(new Objects.NewProduct("N14", "GXMO-P10-Projector-EU-Plug-523933-1._w280_p1_", "GXMO P10 LCD Projector, 300ANSI 1280*720P, 2.4/5G", 129.24, 0, 2, "Free"));
            ListNewPage.Add(new Objects.NewProduct("N15", "wireless-keyboard-for-ipad-pro-12-9-inch-white-446b74-1711525553813._w280_p1_", "Wireless Bluetooth 5.3 Keyboard for 12.9'' iPad Pro", 60.98, 68.28, 1, "Free"));
            ListNewPage.Add(new Objects.NewProduct("N16", "66355ae64dc94768b9b6deeb80e7d0c6-523979-3._w280_p1_", "Tronsmart Sounfii R4 TWS ENC Call Noise Reduction", 13.81, 16.25, 7, "Free"));
