<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="electronic_store.Cart" %>
            ...
            <div class=" shoppingCart" id="shoppingCart" runat="server">
                ...
                <div id="product" class="product">
                    <%string user = (string)Session["username"];
                        List<electronic_store.Objects.products> cart = (List<electronic_store.Objects.products>)Application["listCart"];
                        ...
                        if (user != null)
                        {
                            if (cart.Count() > 0)
                            {
                                foreach (electronic_store.Objects.products product in cart)
                                {
